...
//		uhf.close_reader();
	...
	private void initView(){
		...
		tvVersionx = (TextView)findViewById(R.id.versionx);
		tvVersion.setVisibility(View.GONE);
		tvVersionx.setVisibility(View.GONE);
		tvIp=(EditText)findViewById(R.id.IP);
	...
	public void onClick(View view) {
		if(view == bOpen){
			...
			UhfGetData.GetUhfInfo();
			UfhData.setIP(tvIp.getText().toString());
			mHandler.removeMessages(MSG_SHOW_PROPERTIES);
			mHandler.sendEmptyMessage(MSG_SHOW_PROPERTIES);
		}
	}
